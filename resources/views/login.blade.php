...
<head>
    ...
    <!-- Tailwind CSS CDN untuk kemudahan styling persis mockup -->
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="h-screen w-screen overflow-hidden m-0 p-0 font-sans">

    <!-- Container Utama dengan Background Gradasi Biru (Mockup 1) -->
    <div class="w-full h-full bg-gradient-to-tr from-[#2563eb] via-[#60a5fa] to-[#bfdbfe] flex flex-col justify-center items-center relative">
        ...
        <!-- Tulisan Login di Pojok Kiri Atas -->
        ...
        <div class="bg-white p-8 rounded-2xl shadow-xl w-[420px]">
            <form action="{{ url('/materi') }}" method="GET">
                ...
                <div class="mb-5">
                    ...
                    <input type="email" placeholder="Value" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                </div>
                
                <div class="mb-6">
                    <label class="block text-gray-700 text-xs font-semibold mb-2">Password</label>
                    <input type="password" placeholder="Value" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                </div>
